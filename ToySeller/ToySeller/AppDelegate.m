...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.userAccountViewController = [[UserAccountViewController alloc] initWithNibName:@"UserAccountViewController" bundle:nil];
    UINavigationController *controller = [[UINavigationController alloc] initWithRootViewController:self.userAccountViewController];
    ...
    UIImage *imgForBack = [ self imageWithColor:[UIColor colorWithRed:255.0f/255.0f green:223/255.0f blue:203.0f/255.0f alpha:1.0f]];
    ...
    [navAppearance setBarTintColor:[UIColor colorWithRed:255.0f/255.0f green:223/255.0f blue:203.0f/255.0f alpha:1.0f]];
