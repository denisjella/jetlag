...
- (void)viewDidLoad
{
    ...
    [self.navigationController.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName : [UIColor colorWithRed:70.0f/255.0f green:117.0f/255.0f blue:57.0f/255.0f alpha:1.0]}];
    // self.navigationController.navigationBar.tintColor = [UIColor colorWithRed:70.0f/255.0f green:117.0f/255.0f blue:57.0f/255.0f alpha:1.0];
    ...
    if (!self.toolbarItems) {
        ...
        [constrainButton setTintColor:[UIColor colorWithRed:70.0f/255.0f green:117.0f/255.0f blue:57.0f/255.0f alpha:1.0]];
