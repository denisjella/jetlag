...
- (void)viewDidLoad
{
	...
	[btBack setImage:[UIImage imageNamed:@"BtnBackSetup"] forState:UIControlStateNormal];
	[btBack setFrame:CGRectMake(0, 0, 13, 21)];
	[btBack addTarget:self action:@selector(backAction:) forControlEvents:UIControlEventTouchUpInside];
	
	UIBarButtonItem *backButtonItem = [[UIBarButtonItem alloc] initWithCustomView:btBack];
